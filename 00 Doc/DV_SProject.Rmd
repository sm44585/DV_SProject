...
#####Scatterplot
This plot looks at how the combined MPG of all cars in different year ranges since 1985 to 2016. This plot was created to see if a trend was present. The server script for this plot is wrapped in an eventReactive function that fires only when the user presses the "Generate PV4 Plot" after changing the begining year and end year slider inputs that the user wants to look at.
